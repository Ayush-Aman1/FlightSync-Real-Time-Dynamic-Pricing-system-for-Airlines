            ...
            activities: {
               ...
               items: {
                  ...
                  properties: {
                     action: { 
                        bsonType: "string",
                        enum: ["search", "view_flight", "add_to_cart", "remove_from_cart", 
                               "abandoned_booking", "completed_booking", "view_price", 
                               "filter_applied", "sort_applied", "page_view"]
                     },
                     timestamp: { bsonType: "date" },
                     details: {
                        bsonType: "object",
...
db.flight_reviews.createIndex({ "customer_id": 1, "booking_id": 1 }, { unique: true });
         ...
         properties: {
            ...
            historical_analysis: {
               ...
               properties: {
                  ...
                  price_trend: { bsonType: "string", enum: ["rising", "falling", "stable"] },
                  demand_trend: { bsonType: "string", enum: ["increasing", "decreasing", "stable"] }
               }
            },
            recommendations: {
               bsonType: "array",
...
db.ai_pricing_insights.createIndex({ "expires_at": 1 }, { expireAfterSeconds: 0 });
